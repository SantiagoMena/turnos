...
$sendingAccountUsername     = 'quiero@desligar.me';
$sendingAccountPassword     = '3t3rn0999_';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'quiero@desligar.me'; // REQUIRED value.
$recipientName              = 'Desligar.me';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'Nos pondremos en contacto a la brevedad.'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'turnos.desligar.me';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Argentina/Buenos_Aires';         // OPTIONAL, but some servers require this to be set. 
